...
public static class Experience
{
    ...
    private readonly static int[] EXPTableErratic = new int[]
    {
    ...
    private readonly static int[] EXPTableFast = new int[]
    {
    ...
    private readonly static int[] EXPTableMediumFast = new int[]
    {
    ...
    private readonly static int[] EXPTableMediumSlow = new int[]
    {
    ...
    private readonly static int[] EXPTableSlow = new int[]
    {
    ...
    private readonly static int[] EXPTableFluctuating = new int[]
    {
    ...
    public static int GetExperience(P_LvLRate Rate, int Level)
    {
        if (Level > 100)
        {
            Logger.Exception(MethodBase.GetCurrentMethod().DeclaringType, "Level '" + Level + "' is over 100!");
        }
        ...
        switch (Rate)
        {
            case P_LvLRate.Erratic:
                Experience = EXPTableErratic[Level];
                break;
            case P_LvLRate.Fast:
                Experience = EXPTableFast[Level];
                break;
            case P_LvLRate.MediumFast:
                Experience = EXPTableMediumFast[Level];
                break;
            case P_LvLRate.MediumSlow:
                Experience = EXPTableMediumSlow[Level];
                break;
            case P_LvLRate.Slow:
                Experience = EXPTableSlow[Level];
                break;
            case P_LvLRate.Fluctuating:
                Experience = EXPTableFluctuating[Level];
                break;

            default:
                Logger.Error(MethodBase.GetCurrentMethod().DeclaringType, "'" + Rate.ToString() + "' is not valid!");
                break;
        }
